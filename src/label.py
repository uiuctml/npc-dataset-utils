...
def createViewer():
    ...
    group_box.setAlignment(PyQt5.QtCore.Qt.AlignHCenter)
    group_box.setLayout(layout)
    group_box.setTitle("Viewer")
    ...
    for i in range(0, header.label_viewer_items):
        ...
        layout.addWidget(label, i // header.label_viewer_items_row, i % header.label_viewer_items_row)

    return group_box

def createLabelingControls():
    group_box_controls = PyQt5.QtWidgets.QGroupBox()
    layout_group_box_controls = PyQt5.QtWidgets.QGridLayout()

    group_box_controls.setAlignment(PyQt5.QtCore.Qt.AlignHCenter)
    group_box_controls.setLayout(layout_group_box_controls)
    group_box_controls.setTitle("Labeling Controls")
    ...
    for dataset in config["datasets"]:
        ...
        layout_group_box_controls.addWidget(group_box_control)
...
def createApplicationControls():
    ...
    group_box.setAlignment(PyQt5.QtCore.Qt.AlignHCenter)
    group_box.setLayout(layout)
    group_box.setTitle("Application Controls")
    layout.addWidget(push_button_save_and_last, 0, 1)
    layout.addWidget(push_button_last, 0, 2)
    layout.addWidget(push_button_load, 0, 3)
    layout.addWidget(push_button_save, 0, 4)
    layout.addWidget(push_button_next, 0, 5)
    layout.addWidget(push_button_save_and_next, 0, 6)
